...
class Cart extends Model
{
    ...
    protected $fillable = ['product_id', 'product_seller_id', 'product_price', 'product_price_discount',
        'product_color', 'product_vendor', 'product_warranty', 'user_id', 'count', 'countryName', 'ip', 'countryCode', 'regionCode', 'regionName', 'cityName', 'zipCode', 'latitude', 'longitude', 'areaCode', 'type', 'read_cart', 'view', 'price_old', 'product_price_discount_old'];
