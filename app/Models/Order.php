...
class Order extends Model
{
    ...
    protected $fillable = ['product_id', 'type_order', 'order_number', 'product_seller_id',
        ...
        'user_id', 'product__color_id', 'count', 'type_send', 'countryName', 'ip', 'countryCode', 'regionCode', 'address_id', 'proPriceCountD',
        'regionName', 'cityName', 'total_price', 'total_discount_price', 'zipCode', 'latitude', 'longitude', 'areaCode', 'type', 'status', 'proPriceCount',
