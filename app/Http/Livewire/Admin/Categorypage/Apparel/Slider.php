...
class Slider extends Component
{
    ...
    {
        $slider = DB::connection('mysql-apparel')
        ...
        $slider2 = DB::connection('mysql-apparel')
            ->table('category_apparel_slider')
            ->where('link', $this->link)
            ->first();

        $slider3 = DB::connection('mysql-apparel')
            ->table('category_apparel_slider')
            ->where('id', $slider2->id)
            ->limit($slider2->id);
    ...
    {
        $sliders = $this->readyToLoad ? DB::connection('mysql-apparel')
            ->table('category_apparel_slider')
