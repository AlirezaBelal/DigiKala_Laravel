...
class Amazing extends Component
{
    ...
    {
        $category2 = DB::connection('mysql-apparel')
            ->table('category_apparel_amazing')
            ->where('id', $id)
            ->first();

        $category = DB::connection('mysql-apparel')
            ->table('category_apparel_amazing')
            ->where('id', $id)
            ->limit($id);
    ...
    {
        $amazing2 = DB::connection('mysql-apparel')
            ->table('category_apparel_amazing')
            ->where('id', $id)
            ->first();

        $amazing = DB::connection('mysql-apparel')
            ->table('category_apparel_amazing')
            ->where('id', $id)
            ->limit($id);
