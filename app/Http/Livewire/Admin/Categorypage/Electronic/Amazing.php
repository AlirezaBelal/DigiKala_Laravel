...
class Amazing extends Component
{
    ...
    public function categoryForm()
    {
        ...
        DB::connection('mysql-electronic')
    ...
    {
        $category2 = DB::connection('mysql-electronic')
            ->table('category_electronic_amazing')
            ->where('id', $id)
            ->first();

        $category = DB::connection('mysql-electronic')
            ->table('category_electronic_amazing')
            ->where('id', $id)
            ->limit($id);
    ...
    {
        $amazing2 = DB::connection('mysql-electronic')
            ->table('category_electronic_amazing')
            ->where('id', $id)
            ->first();

        $amazing = DB::connection('mysql-electronic')
            ->table('category_electronic_amazing')
            ->where('id', $id)
            ->limit($id);
