...
class Slider extends Component
{
    ...
    {
        $slider = DB::connection('mysql-category')
        ...
        $slider2 = DB::connection('mysql-category')
            ->table('category_slider')
            ->where('link', $this->link)
            ->first();

        $slider3 = DB::connection('mysql-category')
            ->table('category_slider')
            ->where('id', $slider2->id)
            ->limit($slider2->id);
    ...
    {
        $sliders = $this->readyToLoad ? DB::connection('mysql-category')
            ->table('category_slider')
