...
class Index extends Component
{
    public function render()
    {
        ...
        $sliders = DB::connection('mysql-apparel')
            ->table('category_apparel_slider')
            ->where('status', 1)
            ->get();

        $amazings = DB::connection('mysql-apparel')
            ->table('category_apparel_amazing')
            ->get();

        $banners = DB::connection('mysql-apparel')
            ->table('category_apparel_banner')
            ->where('type', 0)
            ->take(4)
            ->get();

        $bigbanners = DB::connection('mysql-apparel')
            ->table('category_apparel_banner')
            ->where('type', 1)
            ->take(2)
            ->get();

        $bigbanners2 = DB::connection('mysql-apparel')
            ->table('category_apparel_banner')
            ->where('type', 1)
            ->skip(2)
            ->take(2)
        ...
        $title_count = DB::connection('mysql-apparel')
            ->table('category_apparel_title_swiper')
            ->get();

        $products = DB::connection('mysql-apparel')
            ->table('category_apparel_product_swiper')
            ->where('status', 1)
            ->get();

        $brands = DB::connection('mysql-apparel')
