    ...
    @if($banner_13)
        <a
            ...
            <div class="c-adplacement__sponsored_box"><img
                    src="{{\Illuminate\Support\Facades\Storage::url($banner_13->img)}}"
                    alt="{{$banner_13->title}}" loading="lazy">
            </div>
        </a>
    @endif
    @if($banner_14)
        <a href="{{$banner_14->link}}"
           ...
           data-gtm-vis-total-visible-time-9070001_346="100" data-gtm-vis-has-fired-9070001_346="1">
            <div class="c-adplacement__sponsored_box"><img
                    src="{{\Illuminate\Support\Facades\Storage::url($banner_14->img)}}"
