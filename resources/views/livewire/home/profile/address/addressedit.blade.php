<div>
    <div class="o-box" id="address-section" style="margin-right: 200px">
        <div class="o-box__header"><span class="o-box__title">
                ویرایش آدرس
            ...
            <form wire:submit.prevent="addressForm"
                ...
                <div class="c-address__modal-content " id="address-modal-form">
                    ...
                    <div class="c-address__form">
                        ...
                        <div class="c-address__form-row">
                            <div class="c-address__form-row c-address__form-row--z-index-0 ">
                    ...
                    <div class="c-address__form">
                        <div class="c-address__form-row
                     c-address__form-row--z-index-0 ">
                            <input type="hidden" class="js-address-id" placeholder=" ">
                            <label class="o-form__field-container">
                                <div class="o-form__field-label">
                                    نام گیرنده*
                                </div>
