<section class="o-page__content">
    <div class="o-box">
        ...
        <div class="c-profile-order__content js-ui-tab-content">
            @foreach(\App\Models\Order::where('user_id',auth()->user()->id)->where('status','paid')->get() as $payment)
                    ...
                    <div class="c-profile-order__list-item-details">
                        <div class="c-profile-order__list-item-details-top ">
                            <div class="c-profile-order__list-item-details-row">
                                <div
                                    class="c-profile-order__list-item-detail">
                                    {{\App\Models\PersianNumber::translate(jdate($payment->created_at)->format(' %d %B %Y'))}}</div>
                        ...
                        <div class="c-profile-order__list-item-parcel">
                            <div class="c-profile-order__list-item-parcel-top">
                                ...
                                <div class="c-order-status-bar"><div class="c-order-status-bar__status"><div class="c-order-status-bar__current-status" style="color: #2e7b32;">
                                            خروج از مرکز پردازش
                                        </div></div><div class="c-order-status-bar__progress"><div class="c-order-status-bar__progress-bar" style="background-color: #4caf50; width: 67%;"></div></div></div>
                            </div>
